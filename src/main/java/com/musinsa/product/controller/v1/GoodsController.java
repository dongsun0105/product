...
public class GoodsController {
    ...
    @GetMapping("/{goodsNo}")
    public CommonResponse<GoodsRes> getGoods(@PathVariable Integer goodsNo) throws Exception {
    ...
    @PutMapping("/{goodsNo}")
    public CommonResponse<Void> updateGoods(@PathVariable Integer goodsNo, @RequestBody @Valid GoodsReq goodsReq) throws Exception {
        goodsService.updateGoods(goodsNo, goodsReq);
        return new CommonResponse<>();
    }

    @DeleteMapping("/{goodsNo}")
    public CommonResponse<Void> deleteGoods(@PathVariable Integer goodsNo) throws Exception {
